...
class ReplicateLayoutGUI ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Replicate layout", pos = wx.DefaultPosition, size = wx.Size( 364,710 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
